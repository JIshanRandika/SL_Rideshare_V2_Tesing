...
export default function FavouriteRouteCreateMapScreen({ navigation }) {
    ...
    const handleStart = () => {
        ...
        navigation.navigate('favouriteRouteScreen');
    };
    ...
    return (
        <View style={{ flex: 1, backgroundColor: Colors.background }}>
            ...
            <View style={{flex: 10}}>
                ...
                >
                    <Text style={{ color: Colors.colorD, fontWeight: 'bold' }}>Save</Text>
                </TouchableOpacity>
                ...
                <Modal
                    ...
                    <View style={styles.centeredView}>
                        <View style={styles.modalView}>
                            <FormItem
                                style={{borderRadius:50,borderColor:Colors.colorD,borderWidth:2,width:240}}
