...
export default function AvailableDrivesDetailsSearchScreen({navigation}) {
    ...
    const handleStart = () => {
        ...
        navigation.navigate('availableDrivesDetail');
    };
            ...
            <SafeAreaView style={{ flex: 1, padding: 24 }}>
                <ScrollView keyboardShouldPersistTaps="handled">
                    ...
                    <View style={{ padding: 24 }}>
                        ...
                        <TouchableOpacity onPress={()=>navigation.navigate('availableDrivesDetail')} style={{backgroundColor:Colors.colorA,padding:15,alignItems:'center',borderRadius:50}}>
