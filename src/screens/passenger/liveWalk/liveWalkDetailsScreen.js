...
export default function LiveWalkDetailsScreen({navigation}) {
            ...
            <SafeAreaView style={{ flex: 1, padding: 24 }}>
                <ScrollView keyboardShouldPersistTaps="handled">
                    ...
                    <View style={{ padding: 24 }}>
                        ...
                        <TouchableOpacity onPress={()=>navigation.navigate('liveWalkMapCreate')} style={{backgroundColor:Colors.colorA,padding:15,alignItems:'center',borderRadius:50}}>
